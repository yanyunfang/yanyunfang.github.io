...
var liuyao = {
  ...
  GetGua: function (guaArray) {
    ...
    console.log("刑合克合，终见乖戾。动值合而绊住，静得冲而暗兴。入墓难克，带旺非空。有助有扶，衰弱休囚亦吉；贪生贪合，刑冲克害皆忘。别衰旺以明克合，辨动静以定刑冲。并不并，冲不冲，因多字眼；刑非刑，合非合，为少支神。爻遇令星，物难我害；伏居空地，事与心违。伏无提拔终徒尔，飞不推开亦枉然。空下伏神，易于引拔，制中弱主，难以维持。日伤 爻真罹其祸，爻伤日徒受其名。墓是人不冲不发，身上鬼不去不安。\n")
