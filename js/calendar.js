...
var liuyao = {
  ...
  GetGua: function (guaArray) {
    ...
    console.log("《总断千金赋》明 刘基\n")
    console.log("动静阴阳，反复变迁。虽万象之纷纭，须一理以融贯。\n")
    console.log("人有贤不肖之殊，卦有过不及之异。太过者损之斯成，不及者益之则利。生扶拱合，时雨滋苗；克害刑冲，秋霜杀草。长生帝旺，争如金谷之园；死墓空绝，乃是泥犁之地。日辰为六爻之主宰，喜灭项以安刘；月建乃万卦之提纲，岂助桀而为虐。最恶者岁君，宜静而不宜动；最要者身位，喜扶而不喜伤。\n")
    console.log("世为己，应为人，大宜契合；动为始，变为终，身相交争。应位遭伤不利他人之事，世爻受制岂宜自己之谋。世应俱空，人无准实；内外竞发，事必翻腾。世或交重，两目顾瞻于马首；应好发动，一心似托于猿攀。用神有气无他故，所做皆成；主象徒存更被伤，凡谋不易。有伤须救，无故勿空。空逢冲而有用，合遭破以无功。自空化空，必成凶咎。\n")
    console.log("刑合克合，终见乖戾。动值合而绊住，静得冲而暗兴。入墓难克，带旺非空。有助有扶，衰弱休囚亦吉；贪生贪合，刑冲克害皆忘。别衰旺以明克合，辨动静以定刑冲。并不并，冲不冲，因多字眼；刑非刑，合非合，为少支神。爻遇令星，物难我害；伏居空地，事与心违。伏无提拔终徒尔，飞不推开亦枉然。空下伏神，易于引拔，制中弱主，难以维持。日伤爻真罹其祸，爻伤日徒受其名。墓中人不冲不发，身上鬼不去不安。\n")
    console.log("德入卦而无谋不遂，忌临身而多阻无成。卦遇凶星，避之则吉。爻逢忌煞，敌之无伤。主象休囚怕见刑冲克害，用爻变动忌遭死墓空绝。用化用，有用无用；空化空，虽空不空。养主狐疑，墓多暧昧。化病兮损伤，化胎兮勾连。凶化长生，炽而未散。吉连沐浴，败而无成。戒回头之克我，勿反德以扶人。恶曜孤寒，怕日辰之并起；用爻重叠，喜墓库以收藏。事阴隔兮间发，心退悔兮世空。卦爻发动，须看交重。动变比和，当明进退。煞生身莫将吉断，用克世勿做凶看。\n")
    console.log("盖生中中刑害之两防，而合处有克伤之一虑，刑害不宜临用，死绝岂可持身。动逢冲而事散，绝逢生而事成。如逢合住，须冲破以成功；若遇休囚，必生旺而成事。速则动而克世，缓则静而生身。父亡而事无头绪，福隐而事不称情。鬼虽灾祸，伏犹无气；子虽福德，多反无功。究父母推为休统，论官鬼断做祸殃。财乃禄神，子为福德。兄弟交重，必至谋为多阴滞；卦身重叠，须知事体两交关。虎兴而遇吉神不害其为吉，龙动而逢凶曜难其为凶。武主盗贼之事亦必官爻，雀本口舌之神然须兄弟。疾病大宜天喜，若临凶煞必生悲；出行最怕往亡，如系吉神终获利。是故吉凶神煞之多端，何如生克制化之一理。\n")
    console.log("鸣呼，卜易者知前则易，求占者鉴后则灵。筮必诚心，何妨子日。\n")
    return result
  },
  ...
  GetGuaItem: function (guaKeyArray) {
    ...
    for (let i = 0; i < guaKeyArray.length; i++) {
      ...
      const guaItemObj = {
        ...
        "yingIndex": i !== 0 ? undefined : (shiIndex + 2) % 6 + 1,
  ...
  //     console.log("刑合克合，终见乖戾。动值合而绊住，静得冲而暗兴。入墓难克，带旺非空。有助有扶，衰弱休囚亦吉；贪生贪合，刑冲克害皆忘。别衰旺以明克合，辨动静以定刑冲。并不并，冲不冲，因多字眼；刑非刑，合非合，为少支神。爻遇令星，物难我害；伏居空地，事与心违。伏无提拔终徒尔，飞不推开亦枉然。空下伏神，易于引拔，制中弱主，难以维持。日伤爻真罹其祸，爻伤日徒受其名。墓中人不冲不发，身上鬼不去不安。\n")
  //     console.log("德入卦而无谋不遂，忌临身而多阻无成。卦遇凶星，避之则吉。爻逢忌煞，敌之无伤。主象休囚怕见刑冲克害，用爻变动忌遭死墓空绝。用化用，有用无用；空化空，虽空不空。养主狐疑，墓多暧昧。化病兮损伤，化胎兮勾连。凶化长生，炽而未散。吉连沐浴，败而无成。戒回头之克我，勿反德以扶人。恶曜孤寒，怕日辰之并起；用爻重叠，喜墓库以收藏。事阴隔兮间发，心退悔兮世空。卦爻发动，须看交重。动变比和，当明进退。煞生身莫将吉断，用克世勿做凶看。\n")
  //     console.log("盖生中刑害之两防，而合处有克伤之一虑，刑害不宜临用，死绝岂可持身。动逢冲而事散，绝逢生而事成。如逢合住，须冲破以成功；若遇休囚，必生旺而成事。速则动而克世，缓则静而生身。父亡而事无头绪，福隐而事不称情。鬼虽灾祸，伏犹无气；子虽福德，多反无功。究父母推为休统，论官鬼断做祸殃。财乃禄神，子为福德。兄弟交重，必至谋为多阴滞；卦身重叠，须知事体两交关。虎兴而遇吉神不害其为吉，龙动而逢凶曜难其为凶。武主盗贼之事亦必官爻，雀本口舌之神然须兄弟。疾病大宜天喜，若临凶煞必生悲；出行最怕往亡，如系吉神终获利。是故吉凶神煞之多端，何如生克制化之一理。\n")
  //     console.log("鸣呼，卜易者知前则易，求占者鉴后则灵。筮必诚心，何妨子日。\n")
};
